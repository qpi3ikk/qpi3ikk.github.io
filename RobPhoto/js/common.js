...
$(window).scroll(function() {
    $('.mov').each(function(){
      ...
      if (imagePos < topOfWindow+(window.innerHeight/1.3)) {
...
$('#gamburger').click(function() {
	...
	$('.menu').toggleClass('fadeInDown');
	$('.menu').toggleClass('show');
});

 // Плавна перемотка Стрілки
 $(".down-btn").click(function (event) {
     event.preventDefault();// исключаем стандартную реакцию браузера
     var id  = $('#about'),// получем идентификатор
         top = $(id).offset().top - 85;// находим высоту, на которой расположен блок
...
$(document).ready(function(){
	var galleryFeed = new Instafeed({
		get: "user",
		userId: '9964918778',
		accessToken: '9964918778.1677ed0.28d238b87c154df485f1b88207f050b4',
	  ...
	  var btnInstafeedLoad = document.getElementById("btn-instafeed");
